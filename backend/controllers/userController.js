...
//     try {
//       await sendEmail({ email: user.email, subject: 'Email Verification - DSA Revision Platform', message });
//      // await sendEmail({
//      //      email: user.email,
//      //      subject: 'Welcome to AlgoRecall!',
//      //      template: 'welcome',
//      //      templateData: {
//      //      name: user.name,
//      //      }
...
//       type: "expired",
//       message: "Token is invalid or has expired.",
//       email: user.email // Add this - include the email for resend functionality
//     });
//   }
...
//     await sendEmail({ 
//       email: user.email, 
//       subject: 'Email Verification - DSA Revision Platform', 
//       message 
//     });
...
//   try {
//     await sendEmail({ email: user.email, subject: 'Password Reset Token (Valid for 10 min)', message });
...
//       token: generateToken(updatedUser._id), // Send back a new token if you want
//     });
//   } else {
//     res.status(404);
//     throw new Error('User not found');
...
// export { registerUser, verifyEmail, resendVerification, updateUserProfile, loginUser, forgotPassword, resetPassword, getUserProfile, changePassword, deleteUserAccount };
