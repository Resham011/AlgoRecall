...
//   },
//   problemsPerRevision: { // This will now be a calculated field
//     type: Number,
//     default: 5,
//   },
  
//   // --- NEW FIELDS FOR CUSTOM REVISION ---
//   revisionMode: {
//     type: String,
//     enum: ['RANDOM', 'TOPIC', 'COMPANY', 'COMBO'],
//     default: 'RANDOM', // Default to random selection from all problems
//   },
//   customRevisionTopics: {
//     // Stores selected topics/patterns if mode is 'TOPIC' or 'COMBO'
//     type: [String],
//     default: [],
//   },
//   customRevisionCompanies: {
//     // Stores selected companies if mode is 'COMPANY' or 'COMBO'
//     type: [String],
//     default: [],
//   },
// }, {
