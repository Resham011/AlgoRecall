...
//       setCounters(prev => {
//         const newProblems = prev.problems < 10000 ? prev.problems + 100 : 10000;
//         const newRevisions = prev.revisions < 50000 ? prev.revisions + 500 : 50000;
//         const newStreak = prev.streak < 1000 ? prev.streak + 10 : 1000;
        
//         if (newProblems === 10000 && newRevisions === 50000 && newStreak === 1000) {
      ...
      <div className="relative max-w-6xl mx-auto px-4" style={{ zIndex: 2 }}>
        ...
        <div className="h-16 mt-4 md:mt-6">
          <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 font-medium">
            AlgoRecall helps you <span className="text-indigo-600 dark:text-indigo-400 font-bold">{typedText}</span>
