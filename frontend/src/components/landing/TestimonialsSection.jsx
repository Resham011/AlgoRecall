  ...
  const testimonials = [
    {
      ...
      text: "AlgoRecall helped me stay consistent with my interview preparation. The spaced repetition system made sure I never forgot important patterns. I landed my dream job at Google!",
      delay: 100
    },
    {
      name: "Karan",
    ...
    },
    {
      ...
      text: "The progress tracking motivated me to keep going. My problem-solving speed has doubled since I started using AlgoRecall. The analytics helped me identify my weak areas.",
      delay: 300
    },
    {
      name: "Jessica",
    ...
    <section className="py-16 bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-gray-900 dark:to-gray-800 rounded-3xl px-4">
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-gray-500 dark:text-gray-400 mt-4 max-w-2xl mx-auto">
          Join thousands of developers who have improved their coding skills with AlgoRecall
        </p>
      </div>
      ...
      {/* <div className="flex justify-center mt-12">
        <div className="flex items-center space-x-4 bg-white dark:bg-gray-800 px-6 py-3 rounded-full shadow">
          <span className="text-sm text-gray-600 dark:text-gray-400">Trusted by developers at</span>
          <div className="flex space-x-4">
            <span className="font-bold text-blue-600 dark:text-blue-400">Google</span>
            <span className="font-bold text-yellow-600 dark:text-yellow-400">Amazon</span>
            <span className="font-bold text-blue-500 dark:text-blue-300">Meta</span>
          </div>
        </div>
      </div> */}
    </section>
